          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                justifyContent:"center", height:"100%", padding:"14px 14px",
                textAlign:"center",
                ...
                {/* Heart icon */}
                <div style={{ marginBottom:"8px", animation:"heartBeat 3s ease-in-out infinite" }}>
                  <Heart size={20} color="#b8282a" fill="rgba(184,40,42,.15)" strokeWidth={1.5}/>
                </div>

                {/* Title */}
                <div style={{ color:"#8a5a20", fontFamily:"Amiri,serif", fontSize:"11.5px",
                ...
                {/* Personalized greeting — name + gendered pronoun */}
                {userName && userName !== "القارئ" ? (
                  <div style={{
                    background:"rgba(184,40,42,.06)", border:"0.8px solid rgba(184,40,42,.2)",
                    borderRadius:"20px", padding:"3px 12px", marginBottom:"9px",
                    color:"#7a1a1a", fontFamily:"Tajawal,sans-serif",
                    fontSize:"11px", fontWeight:700,
                  }}>
                    {isFemale ? `أختي ${userName} 🌿` : `أخي ${userName} ✨`}
                  </div>
                ) : (
                  <div style={{ color:"#5a3510", fontFamily:"Tajawal,sans-serif",
                    fontSize:"11px", fontWeight:700, marginBottom:"9px" }}>
                    {isFemale ? "أختي الغالية" : "أخي الغالي"}
                  </div>
                )}

                {/* Message body */}
                <p style={{ fontFamily:"Tajawal,sans-serif", fontSize:"10px",
                  color:"#4a3010", lineHeight:"1.8", margin:"0 0 10px",
                  textAlign:"justify" }}>
                  {heartMsg}
                </p>
                ...
                <div style={{
                  ...
                  fontFamily:"Amiri Quran,Amiri,serif", fontSize:"10.5px",
                ...
                {/* Gendered footer */}
                <div style={{ marginTop:"10px", fontFamily:"Amiri,serif",
                  fontSize:"9px", color:"#b8862a", fontStyle:"italic" }}>
                  {isFemale
                    ? "تدبّري بعمق يا " + (userName && userName !== "القارئ" ? userName : "أختاه")
                    : "تدبّر بعمق يا " + (userName && userName !== "القارئ" ? userName : "أخي")}
                </div>
              </div>
            </div>
          </div>
